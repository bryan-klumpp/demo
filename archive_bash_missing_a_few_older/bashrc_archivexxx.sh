...
test -e /ram || sudo mkdir /ram
test -f /ram/t.flag || { sudo mount -t tmpfs arbitrary /ram -o size=256M,mode=777 && echo asdf > /ram/t.flag; }  #RAMDISK!
echo getting ready
...
bvar qq '"'
bvar zero $'\0'
bvar work work:w2:Jesse:SunnyRidge:taxable
bvar down ~/Downloads
bvar gs '--------------------------------------------------------------------------------'
...
function mall() {
#source /l/1/mro.sh 7340032 /media/b/6tb_1/Cat/hpt/20150804_hptouch_laptop_sda_550G_md5_d388592fd4aaebf17a6b76fa1846d96b_typed.img /m/hpt1
#source /l/1/mro.sh 59999518720 /media/b/6tb_1/Cat/hpt/20150804_hptouch_laptop_sda_550G_md5_d388592fd4aaebf17a6b76fa1846d96b_typed.img /m/hpt2
#source /l/1/mro.sh 89999278080 /media/b/6tb_1/Cat/hpt/20150804_hptouch_laptop_sda_550G_md5_d388592fd4aaebf17a6b76fa1846d96b_typed.img /m/hpt3
source /l/1/mro.sh 1048576 /media/b/6tb_1/Cat/passport2t/20150801_passport_ddrescue_sde_some_files_already_moved_to_6tb_and_most_accessed_recently_unfortunately_md5_cd44894cd3cc95af911f21f714f33eb6.img /m/passport2t
#source /l/1/mro.sh 1048576 /m/passport2t/crisis/img/hpbig500spinning/hpbig500spinningaux_convsyncnoerror_take3_md5_6a5a6f71c9ed7fa5f69ef133c45cb69a_md5.img /m/hpbig_500_1 #this one files are mostly Windows-encrypted
