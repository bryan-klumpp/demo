...
echo
echo
echo This batch job runs chkdsk c:, and if it succeeds it then runs a sequence of sfc, dism, and sfc again for good measure.  The window can run in the background while the user works.  Please do not restart, sleep, or shutdown, if possible.........................TODO add more instructions
@echo on
