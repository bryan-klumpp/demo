[ $# -eq 0 ] && { c /b; return; }
###### obsolete: [ $1 -eq 1 ] && { test -d ${HOME}/l/1 || { echo $(shpath); return; } } #special case make sure scripts run cached if necessary
invalidlink=''; readlink ${HOME}/l/$1 && return || { 
...
isint $1 && { readlink -e ${HOME}/l/$1; return; }
lsln | grep "$1"; return


test -e ${HOME}/l/$1 && { echo readlink -e ${HOME}/l/$1; return; }
