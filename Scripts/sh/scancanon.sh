...
#scanimage --resolution $scanres -d 'escl:http://localhost:60000' --format=tiff --mode Color | convert - "$scannedfilename" && ls "$scannedfilename" 
scanimage --resolution $scanres -d 'escl:http://localhost:60000' --format=jpeg --mode Color > "$scannedfilename" && ls "$scannedfilename"
